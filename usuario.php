        ...
        <div class="row display-table-row">
            ...
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                ...
                <div class="navi">
                    ...
                    <ul style="list-style-type: none;">
                        ...
                        <li class="active"><a href="usuario.php"><i aria-hidden="true"></i><span class="hidden-xs hidden-sm ">Usuarios <i class="material-icons">list</i></span></a></li>
            ...
            <div class="col-md-10 col-sm-11 display-table-cell v-align">
                ...
                <div class="row">
                    ...
                    <h2 style="margin-top: 5%">Usuarios</h2>
                    ...
                    <div id="app">
                        <v-app id="inspire">
                          ...
                          <v-btn v-for="(accion, index) in item.acciones" :key="index"
                            ...
                            @click="() => handleClick(accion.funcion, item.id_user)">
                        ...
                        <v-card>
                            ...
                            <v-card-actions>
                            <v-btn color="primary" @click="eliminarUsuarioConfirmado(item.id_user)">Eliminar</v-btn>
                        ...
                        <v-card>
                            ...
                            <v-card-text>
                                ...
                                <v-form @submit.prevent="submitForm">
                                    ...
                                    <v-text-field label="ID Usuario" v-model="usuario.id_user" disabled></v-text-field>

                                    <!-- Otros campos editables para modificar datos del usuario -->
                                    <v-text-field label="Nombre completo" v-model="usuario.nombre_usuario"></v-text-field>
                                    <v-text-field label="Correo" v-model="usuario.correo"></v-text-field>
                                    <v-text-field label="Usuario" v-model="usuario.usuario"></v-text-field>
                                    <v-select
                                        label="Rol"
                                        v-model="usuario.rol"
                                        :items="['Admin', 'Usuario']"
...
<script src='https://cdn.jsdelivr.net/npm/vuetify@2.x/dist/vuetify.js'></script><script  src="./scriptUsuario.js"></script>
